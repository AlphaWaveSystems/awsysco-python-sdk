...
Reset: `harness-ctl breaker reset awsysco-python-sdk`
...
- `*.pem, *.key, .env, .env.*, credentials.json`
...
`"vault: scope <scope> not granted to agent awsysco-python-sdk"`
...
Query: `harness-ctl audit awsysco-python-sdk`
Or: `GET http://127.0.0.1:7700/harness/audit?agent=awsysco-python-sdk`
