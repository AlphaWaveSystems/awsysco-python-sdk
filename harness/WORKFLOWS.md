...
# Workflows — awsysco-python-sdk

> Operational patterns enforced by the harness for agent `awsysco-python-sdk`.
...
### Namespace: `awsysco-python-sdk-worker`
...
| `429 Too Many Requests` | Budget exceeded or rate limited | Check `harness-ctl budget awsysco-python-sdk` |
...
| `"cross-namespace read"` | memory: no grant | Only query own namespace (`awsysco-python-sdk-worker`) |
...
- [ ] Budget checked if doing many tool calls: `harness-ctl budget awsysco-python-sdk`
